...
def supervisor_set_date(req):
    ...
    try:
        if req.method == 'POST':
            ...
            tea_select_end = req.POST.get('tea_select_end', '')
...
def supervisor_get_selectteacher(req):
    ...
    dbresult = DBoperater.supervisor_getSelectteacher(limit, offset,search)
    return HttpResponse(renderers.JSONRenderer().render(dbresult))
...
def supervisor_get_selectstudent(req):
    ...
    offset = req.GET.get("offset", '')
    search = req.GET.get("search", '')
    dbresult = DBoperater.supervisor_getSelectstudent(limit, offset,search)
    return HttpResponse(renderers.JSONRenderer().render(dbresult))
...
def director_get_selectstudent(req):
    ...
    limit = req.GET.get("limit", '')
    offset = req.GET.get("offset", '')
    dbresult = DBoperater.director_getSelectstudent(institution_id,tea_no,class_id,stustu,limit, offset)
    return HttpResponse(renderers.JSONRenderer().render(dbresult))
...
def get_teatoopic(req):
    ...
    dbresult = DBoperater.getTeaToopic(limit, offset,tea_no,userid)
    return HttpResponse(renderers.JSONRenderer().render(dbresult))
...
def get_teatoopicnum(req):
    ...
    dbresult = DBoperater.getTeaToopicnum(limit, offset,institutionid)
    return HttpResponse(renderers.JSONRenderer().render(dbresult))
##韩佳琦
...
def get_teatopic(req):
    ...
    limit = req.GET.get("limit", "")
    offset = req.GET.get("offset", "")
    dbresult = DBoperater.getTeaTopic(limit, offset,userid)
    return HttpResponse(renderers.JSONRenderer().render(dbresult))
...
def get_teatopic1(req):
    ...
    limit = req.GET.get("limit", "")
    offset = req.GET.get("offset", "")
    dbresult = DBoperater.getTeaTopic1(limit, offset,userid)
    return HttpResponse(renderers.JSONRenderer().render(dbresult))
...
def supervisor_set_topicnum(req):
    ...
    try:
        if req.method == 'POST':
            ...
            topic_max = req.POST.get('topic_max', '')
